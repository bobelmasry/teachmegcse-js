Revision Notes - Work, Energy, and Power

5. Work, Energy, and Power:

5\.1 Energy conservation: 5.1.1 Work:
...
5\.2 Gravitational potential energy and kinetic energy: 5.2.1 Gravitational potential energy:
...
- The formula for kinetic energy is EK = 1/2mv^2, where m is the mass of the object and v is its velocity.
