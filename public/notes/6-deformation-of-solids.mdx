---
title: 6 Deformation of Solids (AS)
subject : physics
---
...
- For a material deformed within its limit of proportionality, the elastic potential energy (E<sub>P</sub>) can be calculated using **E<sub>P</sub> = 1/2 Fx = 1/2 kx<sup>2</sup>**, where F is the applied force, x is the extension, and k is the spring constant.
