  ...
  <div>
    ...
    <div className="flex justify-center items-center">
      <div className="grid grid-flow-row gap-16 mt-24 sm:mt-36 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 sm:justify-center mb-40 w-11/12 md:w-4/6 lg:w-4/6">
        ...
        <SubjectCard header={"Chemistry (9701)"} revisionNotes={true} topicQuestions={true} link1={"/A-level/chemistry/"} link2={"/A-level/chemistry/revision-notes"} link3={"/A-level/chemistry/topic-questions"} />
