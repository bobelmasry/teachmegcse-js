  ...
  <Navbar session={session} />
    <div className="flex justify-center">
        <div className="w-3/4 sm:w-2/4 md:w-1/4 mt-36 mb-20">
            <h1 className="text-5xl dark:text-white">Welcome to exceed.</h1>
            ...
            <p className="mt-20 text-2xl dark:text-white">Join us on this transformative educational journey and unlock your true potential. Empower yourself with knowledge, gain confidence, and achieve academic excellence with exceed.</p>
            <p className="mt-20 text-2xl dark:text-white">Thank you for being a part of our story.<br />Aly and Amr<br />Co-founders, exceed</p>
