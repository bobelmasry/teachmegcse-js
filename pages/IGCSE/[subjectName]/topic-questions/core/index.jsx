...
import path from 'path';
    ...
    return (
      <>
        ...
        <TopicCard2 header={"Search For A Question"} linkSrc={`/IGCSE/${data.subjectName}/topic-questions/core/search`} />
        <TopicCard2 header={"Practice solving questions"} linkSrc={`/IGCSE/${data.subjectName}/topic-questions/core/solve`} />
        <TopicCard2 header={"List all the questions"} linkSrc={`/IGCSE/${data.subjectName}/topic-questions/core/list`} />
